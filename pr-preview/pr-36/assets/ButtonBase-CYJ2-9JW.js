var Pt=Object.defineProperty;var Vt=(n,t,e)=>t in n?Pt(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e;var ot=(n,t,e)=>Vt(n,typeof t!="symbol"?t+"":t,e);import{r as l,R as H}from"./index-DCXu2c-y.js";import{_ as Bt,c as y,a as at,k as Q}from"./DefaultPropsProvider-tolH4bEA.js";import{j as $}from"./jsx-runtime-D_zvdyIk.js";import{a as lt,s as Z,g as St,c as wt}from"./memoTheme-KRCIbq4o.js";import{u as Dt,_ as Lt,a as Nt,T as it,b as jt}from"./useTimeout-GLrqR6mX.js";import{u as st}from"./useForkRef-BdVMMcKE.js";import{u as _}from"./useEventCallback-BYuPd7TF.js";import{i as rt}from"./isFocusVisible-B8k4qzLc.js";class G{constructor(){ot(this,"mountEffect",()=>{this.shouldMount&&!this.didMount&&this.ref.current!==null&&(this.didMount=!0,this.mounted.resolve())});this.ref={current:null},this.mounted=null,this.didMount=!1,this.shouldMount=!1,this.setShouldMount=null}static create(){return new G}static use(){const t=Dt(G.create).current,[e,a]=l.useState(!1);return t.shouldMount=e,t.setShouldMount=a,l.useEffect(t.mountEffect,[e]),t}mount(){return this.mounted||(this.mounted=$t(),this.shouldMount=!0,this.setShouldMount(this.shouldMount)),this.mounted}start(...t){this.mount().then(()=>{var e;return(e=this.ref.current)==null?void 0:e.start(...t)})}stop(...t){this.mount().then(()=>{var e;return(e=this.ref.current)==null?void 0:e.stop(...t)})}pulsate(...t){this.mount().then(()=>{var e;return(e=this.ref.current)==null?void 0:e.pulsate(...t)})}}function kt(){return G.use()}function $t(){let n,t;const e=new Promise((a,o)=>{n=a,t=o});return e.resolve=n,e.reject=t,e}function vt(n){if(n===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return n}function tt(n,t){var e=function(i){return t&&l.isValidElement(i)?t(i):i},a=Object.create(null);return n&&l.Children.map(n,function(o){return o}).forEach(function(o){a[o.key]=e(o)}),a}function Ft(n,t){n=n||{},t=t||{};function e(d){return d in t?t[d]:n[d]}var a=Object.create(null),o=[];for(var i in n)i in t?o.length&&(a[i]=o,o=[]):o.push(i);var r,p={};for(var u in t){if(a[u])for(r=0;r<a[u].length;r++){var f=a[u][r];p[a[u][r]]=e(f)}p[u]=e(u)}for(r=0;r<o.length;r++)p[o[r]]=e(o[r]);return p}function k(n,t,e){return e[t]!=null?e[t]:n.props[t]}function It(n,t){return tt(n.children,function(e){return l.cloneElement(e,{onExited:t.bind(null,e),in:!0,appear:k(e,"appear",n),enter:k(e,"enter",n),exit:k(e,"exit",n)})})}function Ut(n,t,e){var a=tt(n.children),o=Ft(t,a);return Object.keys(o).forEach(function(i){var r=o[i];if(l.isValidElement(r)){var p=i in t,u=i in a,f=t[i],d=l.isValidElement(f)&&!f.props.in;u&&(!p||d)?o[i]=l.cloneElement(r,{onExited:e.bind(null,r),in:!0,exit:k(r,"exit",n),enter:k(r,"enter",n)}):!u&&p&&!d?o[i]=l.cloneElement(r,{in:!1}):u&&p&&l.isValidElement(f)&&(o[i]=l.cloneElement(r,{onExited:e.bind(null,r),in:f.props.in,exit:k(r,"exit",n),enter:k(r,"enter",n)}))}}),o}var zt=Object.values||function(n){return Object.keys(n).map(function(t){return n[t]})},Ot={component:"div",childFactory:function(t){return t}},et=(function(n){Lt(t,n);function t(a,o){var i;i=n.call(this,a,o)||this;var r=i.handleExited.bind(vt(i));return i.state={contextValue:{isMounting:!0},handleExited:r,firstRender:!0},i}var e=t.prototype;return e.componentDidMount=function(){this.mounted=!0,this.setState({contextValue:{isMounting:!1}})},e.componentWillUnmount=function(){this.mounted=!1},t.getDerivedStateFromProps=function(o,i){var r=i.children,p=i.handleExited,u=i.firstRender;return{children:u?It(o,p):Ut(o,r,p),firstRender:!1}},e.handleExited=function(o,i){var r=tt(this.props.children);o.key in r||(o.props.onExited&&o.props.onExited(i),this.mounted&&this.setState(function(p){var u=Bt({},p.children);return delete u[o.key],{children:u}}))},e.render=function(){var o=this.props,i=o.component,r=o.childFactory,p=Nt(o,["component","childFactory"]),u=this.state.contextValue,f=zt(this.state.children).map(r);return delete p.appear,delete p.enter,delete p.exit,i===null?H.createElement(it.Provider,{value:u},f):H.createElement(it.Provider,{value:u},H.createElement(i,p,f))},t})(H.Component);et.propTypes={};et.defaultProps=Ot;function At(n){const{className:t,classes:e,pulsate:a=!1,rippleX:o,rippleY:i,rippleSize:r,in:p,onExited:u,timeout:f}=n,[d,h]=l.useState(!1),M=y(t,e.ripple,e.rippleVisible,a&&e.ripplePulsate),V={width:r,height:r,top:-(r/2)+i,left:-(r/2)+o},g=y(e.child,d&&e.childLeaving,a&&e.childPulsate);return!p&&!d&&h(!0),l.useEffect(()=>{if(!p&&u!=null){const D=setTimeout(u,f);return()=>{clearTimeout(D)}}},[u,p,f]),$.jsx("span",{className:M,style:V,children:$.jsx("span",{className:g})})}const b=lt("MuiTouchRipple",["root","ripple","rippleVisible","ripplePulsate","child","childLeaving","childPulsate"]),J=550,Xt=80,Yt=Q`
  0% {
    transform: scale(0);
    opacity: 0.1;
  }

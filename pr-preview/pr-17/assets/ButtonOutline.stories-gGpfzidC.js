...
and typography defined in Figma come through via the DesignSystemProvider theme.`,methods:[],displayName:"ButtonOutline",props:{isDisabled:{required:!1,tsType:{name:"boolean"},description:'Disable interaction and apply the Figma "Disabled" variant styling.'},isLoading:{required:!1,tsType:{name:"boolean"},description:"Replace children with a centered spinner and disable the button."},onHover:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Mouse-enter handler (wraps onMouseEnter for API parity with other DS primitives)."},icon:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Optional leading icon slot (renders before children)."}},composes:["Omit"]};const ge={title:"Components/Button/Outline",component:E,args:{children:"Button"},argTypes:{size:{control:{type:"select"},options:["lg","md","sm","xs"]}}},e={},r={args:{isDisabled:!0}},s={args:{isLoading:!0}},a={args:{size:"large"}},t={args:{size:"medium"}},o={args:{size:"small"}},i={args:{size:"small"}},n={args:{fullWidth:!0}},c={args:{icon:l.jsx(H,{size:16})}};var u,g,f;e.parameters={...e.parameters,docs:{...(u=e.parameters)==null?void 0:u.docs,source:{originalSource:"{}",...(f=(g=e.parameters)==null?void 0:g.docs)==null?void 0:f.source}}};var h,S,z;r.parameters={...r.parameters,docs:{...(h=r.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    isDisabled: true
  }
}`,...(z=(S=r.parameters)==null?void 0:S.docs)==null?void 0:z.source}}};var y,b,x;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {
    isLoading: true
  }
...
}`,...(B=(D=a.parameters)==null?void 0:D.docs)==null?void 0:B.source}}};var O,w,R;t.parameters={...t.parameters,docs:{...(O=t.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
    size: 'medium'
  }
...
}`,...(L=(C=n.parameters)==null?void 0:C.docs)==null?void 0:L.source}}};var N,P,A;c.parameters={...c.parameters,docs:{...(N=c.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    icon: <Star size={16} />
  }
}`,...(A=(P=c.parameters)==null?void 0:P.docs)==null?void 0:A.source}}};const fe=["Default","Disabled","Loading","Size_lg","Size_md","Size_sm","Size_xs","FullWidth","WithIcon"];export{e as Default,r as Disabled,n as FullWidth,s as Loading,a as Size_lg,t as Size_md,o as Size_sm,i as Size_xs,c as WithIcon,fe as __namedExportsOrder,ge as default};

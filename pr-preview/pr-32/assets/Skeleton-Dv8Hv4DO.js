import{r as v}from"./index-DCXu2c-y.js";import{a as C,c as b,k as c,e as u}from"./DefaultPropsProvider-4fy5dMm0.js";import{m as k}from"./memoTheme-DTigGV7r.js";import{g as w,a as x,c as R,s as S}from"./styled-9G2oBuYA.js";import{j as $}from"./jsx-runtime-D_zvdyIk.js";function U(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function M(t){return parseFloat(t)}function A(t){return w("MuiSkeleton",t)}x("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const X=t=>{const{classes:e,variant:a,animation:n,hasChildren:o,width:i,height:s}=t;return R({root:["root",a,n,o&&"withChildren",o&&!i&&"fitContent",o&&!s&&"heightAuto"]},A,e)},r=c`
  0% {
    opacity: 1;
  }

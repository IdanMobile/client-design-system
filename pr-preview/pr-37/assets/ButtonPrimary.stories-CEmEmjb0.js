...
}`,...($=(Z=o.parameters)==null?void 0:Z.docs)==null?void 0:$.source},description:{story:'Variant axis "State" = "Focus".',...(re=(ee=o.parameters)==null?void 0:ee.docs)==null?void 0:re.description}}};var ae,te,se,ie,ne;d.parameters={...d.parameters,docs:{...(ae=d.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  args: {
    children: 'Button (Primary)',
    state: 'disabled'
  }
}`,...(se=(te=d.parameters)==null?void 0:te.docs)==null?void 0:se.source},description:{story:'Variant axis "State" = "Disabled".',...(ne=(ie=d.parameters)==null?void 0:ie.docs)==null?void 0:ne.description}}};var oe,de,ce,me,le;c.parameters={...c.parameters,docs:{...(oe=c.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  args: {
    children: 'Button (Primary)',
    isLoading: true
  }
...
}`,...(ge=(pe=m.parameters)==null?void 0:pe.docs)==null?void 0:ge.source},description:{story:"Disabled state.",...(he=(ye=m.parameters)==null?void 0:ye.docs)==null?void 0:he.description}}};var ve,fe,Be,be,Se;l.parameters={...l.parameters,docs:{...(ve=l.parameters)==null?void 0:ve.docs,source:{originalSource:`{
  args: {
    children: 'Button (Primary)',
    icon: <Sparkles size={16} />
  }
}`,...(Be=(fe=l.parameters)==null?void 0:fe.docs)==null?void 0:Be.source},description:{story:"Rendered with a leading icon.",...(Se=(be=l.parameters)==null?void 0:be.docs)==null?void 0:Se.description}}};const Ye=["Default","Type_IconButton","Size_Md","Size_Sm","Size_Xs","Width_FluidBlock","State_Hover","State_Focus","State_Disabled","Loading","Disabled","WithIcon"];export{e as Default,m as Disabled,c as Loading,a as Size_Md,t as Size_Sm,s as Size_Xs,d as State_Disabled,o as State_Focus,n as State_Hover,r as Type_IconButton,i as Width_FluidBlock,l as WithIcon,Ye as __namedExportsOrder,Ue as default};

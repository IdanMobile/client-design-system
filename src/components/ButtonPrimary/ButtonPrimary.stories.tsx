...
export const Focus: Story = { args: { sx: { ':focus': { backgroundColor: 'var(--color-background-state-interaction-hover-primary)' } } } };
export const IconOnly: Story = { args: { children: <Star size={16} />, type: 'icon' } };
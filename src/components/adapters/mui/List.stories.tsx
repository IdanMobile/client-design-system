...
export const Default: Story = {
  render: () => (
    <div style={{ height: 320, overflowY: 'auto', border: '1px solid var(--color-muted)', borderRadius: 8, width: 320 }}>
      <List>
        {items.map((item, i) => (
...
const avatarColors = ['var(--color-accent)', 'var(--color-success)', 'var(--color-destructive)', 'var(--color-accent)', 'var(--color-warning)', 'var(--color-accent)'];

export const WithIcons: Story = {
  render: () => (
    <div style={{ height: 320, overflowY: 'auto', border: '1px solid var(--color-muted)', borderRadius: 8, width: 360 }}>
      <List>
